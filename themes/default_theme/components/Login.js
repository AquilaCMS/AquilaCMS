                                        ...
                                        <ul className="list-checkboxes list-checkboxes--flex">
                                            <li>
                                                <div className="checkbox checkbox--medium">
                                                    <input hidden type="radio" name="field-newsletter" defaultChecked={subscribeNL} id="field-yes" onChange={(e) => this.setState({ subscribeNL: true })} />
                                            ...
                                            <li>
                                                <div className="checkbox checkbox--medium">
                                                    <input hidden type="radio" name="field-newsletter" defaultChecked={!subscribeNL} id="field-no" onChange={(e) => this.setState({ subscribeNL: false })} />
