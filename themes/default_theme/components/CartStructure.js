                    ...
                    <div className="shell">
                        <div className="shipping-progress hidden-xs">
                            <ul className="shipping-steps">
                                <li className={`shipping-step${step === 1 ? ' active' : ''}`} onClick={() => (step >= 2 && isClickable ? Router.pushRoute('cartLogin', { lang: routerLang }) : console.warn('non passed step'))}>
                                    <span className="icon">
                                ...
                                <li className={`shipping-step${step === 2 ? ' active' : ''}`} style={{ cursor: step >= 3 && isClickable ? 'pointer' : 'unset' }} onClick={() => (step >= 3 && isClickable ? Router.pushRoute('cartAddress', { lang: routerLang }) : console.warn('non passed step'))}>
                                    <span className="icon">
                                ...
                                <li className={`shipping-step${step === 3 ? ' active' : ''}`} style={{ cursor: step >= 4 && isClickable ? 'pointer' : 'unset' }} onClick={() => (step >= 4 && isClickable ? Router.pushRoute('cartDelivery', { lang: routerLang }) : console.warn('non passed step'))}>
                                    <span className="icon">
                                ...
                                <li className={`shipping-step${step === 4 ? ' active' : ''}`} style={{ cursor: step >= 5 && isClickable ? 'pointer' : 'unset' }} onClick={() => (step >= 5 && isClickable ? Router.pushRoute('cartPayment', { lang: routerLang }) : console.warn('non passed step'))}>
                                    <span className="icon">
