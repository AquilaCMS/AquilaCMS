...
ModulesControllers.controller('ModulesCtrl', [
    '$scope', '$http', 'ConfigV2', '$interval', 'toastService', '$modal', '$translate', 'ModuleServiceV2',
    function ($scope, $http, ConfigV2, $interval, toastService, $modal, $translate, ModuleServiceV2) {
