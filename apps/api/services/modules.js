...
const setFrontModuleInTheme = async (pathModule, theme) => {
    ...
    for (let i = 0; i < filesList.length; i++) {
        ...
        const jsxModuleToImport     = `{jsx: ${!moduleComponentType || moduleComponentType === 'scripts' ? 'require' : 'import'}('./${parsedpkgJson.name}/${file}'), module: '${parsedpkgJson.name}', code: 'aq-${fileNameWithoutModule}', type: '${type}'},`;
