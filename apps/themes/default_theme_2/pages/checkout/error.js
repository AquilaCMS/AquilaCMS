...
export default function CheckoutError() {
    ...
    return (
        <Layout>
            <NextSeoCustom
                noindex={true}
                title={`${environment?.siteName} - ${t('pages/checkout:error.title')}`}
            ...
            <div className="header-section-panier">
                <div className="container-flex-2">
                    <div className="title-wrap-centre">
                        <h1 className="header-h1">{t('pages/checkout:error.titleH1')}</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="section-tunnel">
                <div className="container-tunnel-02">
                    <h2 className="heading-2-steps">{t('pages/checkout:error.paymentNotValidated', { orderId: order.number })}</h2>
                </div>

                <div className="container-order" style={{ justifyContent: 'center' }}>
                    <Link href="/account/orders" className="log-button-03 w-button">
                        {t('pages/checkout:error.homeReturn')}
                    </Link>
                </div>
            </div>
        </Layout>
