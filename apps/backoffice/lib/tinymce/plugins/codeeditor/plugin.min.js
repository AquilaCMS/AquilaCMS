...
<div id="tox-codeeditor-modal" tabindex="-1">
    <div id="tox-codeeditor-header" role="presentation">
        ...
        <button type="button" tabindex="-1" id="tox-codeeditor-close-button">
    ...
    <div id="tox-codeeditor-footer">
        ...
        <select id="tox-codeeditor-theme-picker">
            ${getOptions()}
        </select>
        <div role="presentation" id="tox-codeeditor-footer-buttons">
            <button id="cancel" title="Cancelar" type="button" tabindex="-1" class="tox-codeeditor-secondary-button">Cancel</button>
            <button id="save" title="Salvar" type="button" tabindex="-1"  class="tox-codeeditor-primary-button">Save</button>
        </div>
    </div>
</div>
    `;
    ...
    const exitButton = document.getElementById('tox-codeeditor-close-button');
    ...
    const applyButton = document.getElementById('tox-codeeditor-theme-picker');
    applyButton.addEventListener('change', () => {
        document.getElementById('tox-codeeditor-theme-picker').value;
        applyTheme(document.getElementById('tox-codeeditor-theme-picker').value)
    });
