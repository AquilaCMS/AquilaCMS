...
describe('Sorting by \'Price +\'', function() {
        it('Check Products after sorting by \'Price +\' ', function() {
            ...
            cy.get(link + ' .product--horizontal').then(($prd) => {
                ...
                check_informations('T-shirt marinière rouge', 25, 25, $prd[2].id, 3);
                check_informations('T-shirt blanc/vert', 22, 22, $prd[3].id, 4);
                check_informations('T-shirt basique bleu', 17, 17, $prd[4].id, 5);
                check_informations('T-shirt basique noir', 17, 17, $prd[5].id, 6);
                check_informations('T-shirt basique blanc', 17, 13, $prd[6].id, 7);
                check_informations('Chaussettes bleues', 8, 8, $prd[7].id, 8);
...
describe('Sorting by \'Price +\'', function() {
    it('Check Products after sorting by \'Price +\' in T-shirt category', function() {
        ...
        cy.get(link + ' .product--horizontal').then(($prd) => {
            ...
            check_informations('T-shirt basique noir', 17, 17, $prd[3].id, 4);
            check_informations('T-shirt basique blanc', 17, 17, $prd[4].id, 5);
        })
    })
})
